...
This website is a web version of the CPU emulator by [MattBatWings](https://github.com/mattbatwings) and [AdoHTQ](https://github.com/AdoHTQ) that I am making to go along with the in-game redstone cpu.

It comes complete with:

- A text field to write assembly code in
